...
function App() {
  ...
  /**
   * deletion of item happen when X is clicked which is in <Item/>
   * But its state is in <App/>
   * so define handleDeleteItem in <App/>
   */
  ...
  return (
    <div className="list">
      ...
      <div className="actions">
        ...
        {items.length > 0 && <button onClick={onClearList}>Clear All</button>}
      </div>
    </div>
  );
};
